...
#define LIGHT_THEME_STYLE_PROPS_COUNT  16

// Custom style name: light_theme
static const GuiStyleProp light_themeStyleProps[LIGHT_THEME_STYLE_PROPS_COUNT] = {
...
#define LIGHT_THEME_STYLE_FONT_ATLAS_COMP_SIZE 1950

// Font atlas image pixels data: DEFLATE compressed
static unsigned char light_themeFontData[LIGHT_THEME_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle light_themeFontRecs[189] = {
    { 4, 4, 5 , 16 },
    { 17, 4, 1 , 9 },
    { 26, 4, 3 , 3 },
    { 37, 4, 5 , 7 },
...
static const GlyphInfo light_themeFontGlyphs[189] = {
    { 32, 0, 0, 5, { 0 }},
    { 33, 0, 3, 2, { 0 }},
    { 34, 0, 3, 4, { 0 }},
    { 35, 0, 3, 6, { 0 }},
...
// Style loading function: light_theme
static void GuiLoadStyleLightTheme(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < LIGHT_THEME_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(light_themeStyleProps[i].controlId, light_themeStyleProps[i].propertyId, light_themeStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int light_themeFontDataSize = 0;
    unsigned char *data = DecompressData(light_themeFontData, LIGHT_THEME_STYLE_FONT_ATLAS_COMP_SIZE, &light_themeFontDataSize);
    ...
    memcpy(font.recs, light_themeFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, light_themeFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
