...
#define LIGHT_STYLE_PROPS_COUNT  13

// Custom style name: Light
static const GuiStyleProp lightStyleProps[LIGHT_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x707070ff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, (int)0xd2d2d2ff },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, (int)0x454343ff },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 8, (int)0x202020ff },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, (int)0x6a6a6aff },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, (int)0x36e8ffff },    // DEFAULT_BASE_COLOR_DISABLED 
...
#define LIGHT_STYLE_FONT_ATLAS_COMP_SIZE 2126
...
static const Rectangle lightFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo lightFontGlyphs[189] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
